...
const installationProjects = [
  {
    ...
    description:
      "Complete tiles transformation with premium Calacatta Gold for walls and flooring.",
  ...
  },
  {
    ...
    description:
      "Custom-cut Nero Marquina tiles countertops with waterfall edge design.",
  ...
  },
  {
    ...
    description:
      "Elegant entrance with custom tiles flooring featuring intricate medallion design.",
    location: "Chicago, IL",
    image: g3,
  },
  {
    ...
    description:
      "Book-matched Verde Guatemala tiles wall installation for corporate headquarters.",
    location: "Miami, FL",
    image: g4,
  },
  {
    ...
    description:
      "Massive installation of Statuario tiles with custom inlay design.",
  ...
  },
  {
    ...
    description:
      "Outdoor tiles installation with custom-cut coping and deck tiles.",
...
export default function tilesInstallationShowcase() {
  ...
  const handlePrevSlide = () => {
    ...
    setCurrentSlide((prev) =>
      prev === 0 ? installationProjects.length - 1 : prev - 1
    );
  ...
  const handleNextSlide = () => {
    ...
    setIsAnimating(true);
    setCurrentSlide((prev) =>
      prev === installationProjects.length - 1 ? 0 : prev + 1
    );
    setTimeout(() => setIsAnimating(false), 500);
  };
  ...
  return (
    <div className="w-full bg-gray-100 py-16 relative">
      ...
      <div className="w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Main showcase area */}
        <div
          className="relative w-full overflow-hidden rounded-xl mt-8 shadow-2xl"
          style={{ height: "560px" }}
        >
          {/* Slideshow */}
          <div
              ...
              <div
                ...
                className={`absolute top-0 left-0 w-full h-full transition-all duration-500 ease-in-out ${
                  index === currentSlide
                    ...
                    : index < currentSlide ||
                      (currentSlide === 0 &&
                        index === installationProjects.length - 1)
        ...
        <div className="mt-6 md:hidden">
          <a
            href="#"
            className="flex items-center justify-center w-full px-6 py-3 bg-[#4A9371] text-white font-medium rounded-md hover:bg-green-600 transition-colors"
          >
